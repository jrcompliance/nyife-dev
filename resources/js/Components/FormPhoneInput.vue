...
<template>
    <div :class="className">
        <label for="name" class="block text-sm leading-6 text-gray-900" :class="labelClass">{{ name }}
        ...
        <div>
            <div style="padding:1px"
                ...
                <vue-tel-input :inputOptions="{
                    autocomplete: 'off'
                }" v-model="phone" :autoFormat="true" :mode="'international'" :validCharactersOnly="true"
